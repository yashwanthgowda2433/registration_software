...
class Wills_table extends CI_Model {
    public static $table_name = 'wills';
	public static $id = 'id';
	public static $col1 = 'sl_no';
	public static $col2 = 'book_no';
	public static $col3 = 'date';
	public static $col4 = 'name_of_testator';
	public static $col5 = 'name_of_testatrix';
	public static $col6 = 'village_name';
	public static $col7 = 'page_no';
	public static $col8 = 'page_count';
	public static $col9 = 'district';
    public static $col10 = 'taluk';
    public static $col11 = 'endorsement';
...
class Wills_model extends Wills_table {
    ...
    public function view($params=[])
    {
        ...
        if(!empty($params['col4']))
        {
            ...
            $this->db->or_like(self::$col5, $params['col4']);
