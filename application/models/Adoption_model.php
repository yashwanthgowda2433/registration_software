...
class Adoption_table extends CI_Model {
    public static $table_name = 'adoption';
	public static $id = 'id';
	public static $col1 = 'sl_no';
	public static $col2 = 'book_no';
	public static $col3 = 'date';
	public static $col4 = 'party_one';
	public static $col5 = 'party_two';
	public static $col6 = 'address1';
	public static $col7 = 'address2';
	public static $col8 = 'district';
	public static $col9 = 'taluk';
    public static $col10 = 'page_no';
    public static $col11 = 'page_count';
    public static $col12 = 'pdf_link';
    public static $col13 = 'child_name';
...
class Adoption_model extends Adoption_table {
    ...
    public function view($params=[])
    {
        ...
        {
            $this->db->where("(".self::$col4." LIKE '%".$params['col4']."%' OR ".self::$col5." LIKE '%".$params['col4']."%')", NULL, FALSE);
        }
        if(!empty($params['col5']))
        {
            $this->db->where("(".self::$col4." LIKE '%".$params['col5']."%' OR ".self::$col5." LIKE '%".$params['col5']."%')", NULL, FALSE);
        }
        ...
        if(!empty($params['col13']))
        {
            $this->db->like(self::$col13, $params['col13']);
        }
        if(!empty($params['center']))
        {
            $this->db->where(self::$center, $params['center']);
    ...
    public function add($params=[])
    {
        ...
        if(!empty($params['col13']))
        {
            $this->db->set(self::$col13, $params['col13']);
        }
        if(!empty($params['center']))
        {
