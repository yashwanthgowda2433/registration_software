...
<div class="container">
<form enctype="multipart/form-data" method="post" action="<?php echo base_url('adoption/add');?>">  
	<div class="row heading-row">
		<div class="col-sm-10 text-center mx-auto mt-5">
			...
			<h2 style='font-family: "Tw Cen MT";color:#000;'>Add New adoption</h2>
		</div>
	</div>
    ...
    <div class="row">
        <div class="col-sm-6">
			...
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input type="text" class="form-input" name="col13" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
	...
	<div class="row mb-5">
		...
		<div class="col-sm-5">
		    <div class="row" style="width:100%;display:flex;flex-wrap: unset;margin-left: 0px;">
				...
				<div class="btn btn-dark m-2" onclick="history.back()" id="home" style="width:120px;">Back</div>
