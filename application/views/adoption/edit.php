...
<form enctype="multipart/form-data" method="post" action="<?php echo base_url('adoption/edit/'.$cadet->id);?>">  
    ...
    <div class="row">
		...
		<div class="col-sm-6">
			...
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
					    <input type="text" class="form-input" name="col13" value="<?php echo $cadet->col13;?>" style="width:100%;"/>
			        </div>
		        </div>
	        </div>
		...
		<div class="col-sm-6">
		    <div class="row previewfile" style="display:block">
		        <div class="col-sm-12">
		            <iframe src="<?php echo base_url('pdf/'.$cadet->col12) ?>" id="iframe-pdf" width="100%" height="500px"></iframe>
		        </div>
	        </div>
        </div>
    </div>
...
<script>
	...
	searchFile('adoption','<?php echo $cadet->pdf_link; ?>')
</script>
