...
<div class="container">
<form enctype="multipart/form-data" method="post" action="<?php echo base_url('wills/add');?>">  
	<div class="row heading-row">
		<div class="col-sm-10 text-center mx-auto mt-5">
			...
			<h2 style='font-family: "Tw Cen MT";color:#000;'>Add New wills</h2>
		</div>
	</div>
    ...
    <div class="row">
        <div class="col-sm-6">
			...
			<div class="row heading-row">
		        <div class="col-sm-4 mt-2">
			        <div class="form-control">
				        <label class="form-label">Name of Testator / Testation :</label>
			        </div>
		        </div>
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
			...
			<div class="row heading-row">
		        <div class="col-sm-4 mt-2">
			        <div class="form-control">
				        <label class="form-label">Name of Testatrix :</label>
			        </div>
		        </div>
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
			...
			<div class="row heading-row">
				...
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
						...
						<select class="form-control select2 taluk select2-hidden-accessible" placeholder="Taluka" name="col10"  style="width:100%;">
							<option></option>
			...
			<div class="row heading-row">
		        <div class="col-sm-4 mt-2">
			        <div class="form-control">
				        <label class="form-label">Death Endorsement :</label>
			        </div>
		        </div>
				<div class="col-sm-7 mt-1">
			        <div class="form-control">
