...
<form enctype="multipart/form-data" method="post" action="<?php echo base_url('wills/edit/'.$cadet->id);?>">  
...
<script>
	...
	searchFile('wills','<?php echo $cadet->pdf_link; ?>')
</script>
